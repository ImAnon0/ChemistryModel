...
Revision: `c05d2f6206fd0d180678382e2996d5f530115ad9`
Mode: `full`
...
- **main runtime imports**: PASS (2.49 s)
- **heavy overcoordination guard**: PASS (2.65 s)
- **runner physics selection**: PASS (2.47 s)
- **heavy valence density matrix**: PASS (2.04 s)
- **unified radial baseline equivalence**: PASS (6.85 s)
- **optimised valence integration**: PASS (39.40 s)
- **batched heavy valence**: PASS (139.16 s)
- **large heavy valence states**: PASS (2.54 s)
- **cached H topology**: PASS (15.10 s)
- **factorised H grouped execution**: PASS (26.02 s)
- **H-state components**: PASS (4.55 s)
- **H-state factorised**: PASS (5.69 s)
- **H-state factorised NVE**: PASS (16.82 s)
- **index-select gather**: PASS (47.97 s)
- **smooth valence NVE**: PASS (26.78 s)
- **valence-state factorised fixed**: PASS (16.67 s)
- **valence-state promotion**: PASS (17.29 s)
- **molecule library**: PASS (0.20 s)
- **heavy state pressure diagnostics**: PASS (2.62 s)
- **smooth valence force probe**: PASS (4.77 s)
- **pytest suite**: PASS (165.25 s)
...
- CPU probe: 381.3 steps/s (0.262 s for 100 steps).
