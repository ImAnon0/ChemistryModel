...
Revision: `60e8019f0cadb3c631bb45efdd2ff88861992c6a`
Mode: `full`
...
**FINAL GOLDEN RESULT: FAIL**

- **main runtime imports**: PASS (3.38 s)
- **heavy overcoordination guard**: PASS (3.34 s)
- **runner physics selection**: PASS (3.35 s)
- **heavy valence density matrix**: PASS (2.89 s)
- **optimised valence integration**: PASS (183.52 s)
- **batched heavy valence**: PASS (379.74 s)
- **large heavy valence states**: PASS (3.17 s)
- **cached H topology**: PASS (54.10 s)
- **factorised H grouped execution**: PASS (33.91 s)
- **H-state components**: PASS (4.42 s)
- **H-state factorised**: PASS (7.32 s)
- **H-state factorised NVE**: PASS (25.91 s)
- **index-select gather**: PASS (194.98 s)
- **smooth valence NVE**: PASS (32.23 s)
- **valence-state factorised fixed**: PASS (19.62 s)
- **valence-state promotion**: PASS (19.21 s)
- **molecule library**: PASS (0.18 s)
- **heavy state pressure diagnostics**: PASS (2.71 s)
- **smooth valence force probe**: PASS (5.09 s)
- **pytest suite**: FAIL (204.04 s)
...
- CPU probe: 253.9 steps/s (0.394 s for 100 steps).
